...
import com.prism.authentication.repository.ActicationCodeRepo;
import com.prism.authentication.repository.AuthRepo;
import com.prism.authentication.service.auth.impl.auth.EmailSenderService;
...
public class EmailSenderServiceImpl implements EmailSenderService {
    ...
    public void sendEditUserEmailCode(EmailModel editData, Authentication authentication, HttpServletRequest request) throws PermissionsException, UserNotFoundException, UserAlreadyExistException, EmptyEmailException, IncorectEmailException {
    ...
    public void sendRegitrationCode(UserRegistrationModel user, HttpServletRequest request) throws IncorrectConfirmPasswordException, UserAlreadyExistException, EmptyPasswordException, PasswordIsTooWeakException, TooLongPasswordException, TooShortPasswordException, EmptyEmailException, IncorectEmailException {
        ...
        boolean isConfirmPasswordInorrect = !(user.getConfirmPassword() != null && user.getConfirmPassword().equals(user.getPassword()));
