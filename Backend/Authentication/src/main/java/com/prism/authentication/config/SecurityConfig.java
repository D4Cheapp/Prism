...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http.csrf(AbstractHttpConfigurer::disable).cors(cors -> cors.configurationSource(request -> {
            ...
            request.requestMatchers(loginPath, registrationPath, restorePasswordConfirmPath, emailConfirmPath, swaggerPath, swaggerDocPath, swaggerDocChilds, actuatorPath, actuatorChilds).permitAll();
