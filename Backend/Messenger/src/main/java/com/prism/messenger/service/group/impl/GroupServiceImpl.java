...
public class GroupServiceImpl implements GroupService {
    ...
    public GroupModel createGroup(String email, CreateGroupModel createGroupModel)
            throws EmptyGroupNameException, ServerException, InsufficientDataException,
            ErrorResponseException, NoSuchAlgorithmException, InvalidKeyException,
            InvalidResponseException, XmlParserException, InternalException, IOException {
    ...
    public ProfileModel addGroupAdmin(String email, String profileTag, String dialogId)
    ...
    public GroupListReceiveModel getGroupList(String email, Integer page, Integer size)
        ...
        boolean isTotalCountEmpty =
                groupList.isPresent() && groupList.get()
                        .getTotalCount() == 0 || groupList.isEmpty();
        boolean isGroupListEmpty =
                groupList.isPresent() && isTotalCountEmpty || groupList.isEmpty();
        if (isGroupListEmpty) {
