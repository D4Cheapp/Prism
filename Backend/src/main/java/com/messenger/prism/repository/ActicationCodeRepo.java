...
public class ActicationCodeRepo {
    ...
    public void saveActivationCode(ActivationCodeModel activationCodeModel) {
        redisTemplate.opsForHash().put(activationCodeModel.getEmail(), "code",
                activationCodeModel.getCode());
        redisTemplate.opsForHash().put(activationCodeModel.getEmail(), "id",
                activationCodeModel.getId());
        redisTemplate.opsForHash().put(activationCodeModel.getEmail(), "email",
                activationCodeModel.getEmail());
        redisTemplate.opsForHash().put(activationCodeModel.getEmail(), "password",
                activationCodeModel.getPassword());
        redisTemplate.opsForHash().put(activationCodeModel.getEmail(), "role",
